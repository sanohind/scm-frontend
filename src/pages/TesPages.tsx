            ...
            <table className="table-auto overflow-scroll md:overflow-auto w-full text-left font-inter border ">
              ...
              >
                <tr className="bg-white border border-black">
                  ...
                  <th className="py-3 px-3 text-black sm:text-base font-bold whitespace-nowrap group min-w-[156px]">
              ...
              `}
                  ...
                  <th className="py-3 px-3 flex items-center text-black sm:text-base font-bold whitespace-nowrap group min-w-[157px]">
                    <svg
                      className={`w-4 h-4 cursor-pointer ${
                  ...
                  <th className="py-3 px-3 text-black sm:text-base font-bold whitespace-nowrap group min-w-[197px] ">
                    <div className="flex items-center">
                      <svg
                        className={`w-4 h-4 cursor-pointer ${
                  ...
                  <th className="py-3 px-3 text-black sm:text-base font-bold whitespace-nowrap min-w-[366px]">
                    Description
                  </th>
